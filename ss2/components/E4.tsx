...
const E4 = () => {
  return (
    <View>
        ...
        <ScrollView>
            <Text style={styles.subTitle}>Điều khoản sử dụng</Text>
            <Text style={styles.description}>
                Chào mừng bạn đến với ứng dụng của chúng tôi. Bằng cách truy cập và sử dụng ứng dụng, bạn đồng ý bị ràng buộc bởi các điều khoản và điều kiện này.
            </Text>
            <Text style={styles.description}>
