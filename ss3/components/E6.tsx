...
const E6 = () => {
  ...
  const products: Product[] = [
    ...
    },
    {
      ...
      price: 899,
      image:
        "https://via.placeholder.com/200x200/1BA1E2/FFFFFF?text=Galaxy+S24",
    },
    {
      id: "3",
      name: "MacBook Pro",
    ...
    },
    {
      ...
      name: "iPad Air",
      price: 599,
      image: "https://via.placeholder.com/200x200/F7931E/FFFFFF?text=iPad+Air",
    },
    {
      id: "5",
      name: "Apple Watch",
      price: 399,
      image:
        "https://via.placeholder.com/200x200/FFD23F/000000?text=Apple+Watch",
    },
    {
      id: "6",
      name: "AirPods Pro",
      price: 249,
      image: "https://via.placeholder.com/200x200/EE4B2B/FFFFFF?text=AirPods",
    },
    {
      id: "7",
      name: "Nintendo Switch",
      price: 299,
      image: "https://via.placeholder.com/200x200/00A8E8/FFFFFF?text=Switch",
    },
    {
      id: "8",
      name: "PlayStation 5",
      price: 499,
      image: "https://via.placeholder.com/200x200/003459/FFFFFF?text=PS5",
    },
    {
      id: "9",
      name: "Xbox Series X",
      price: 499,
      image: "https://via.placeholder.com/200x200/107C10/FFFFFF?text=Xbox",
    },
    {
      id: "10",
      name: "Surface Pro",
      price: 999,
      image: "https://via.placeholder.com/200x200/0078D4/FFFFFF?text=Surface",
    },
  ];
  ...
  const renderProduct = ({ item }: { item: Product }) => {
    ...
    return (
      ...
      >
        ...
        <Text style={[styles.productPrice, { fontSize: itemSize.priceSize }]}>
          ${item.price}
        </Text>
      </TouchableOpacity>
    );
    ...
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.subtitle}>
          {Math.round(screenData.width)}x{Math.round(screenData.height)} |{" "}
          {numColumns} columns
        </Text>
      </View>
